...
Task 11 response:
I would think that price, location and type of room, and quality of room/ammenities (though that's not something that is in the table) would all play very big roles in the succes of the airbnb. From the table its a little hard to tell what Is the most important factor/s but generally, basing success on reviews per month, many of the the most successful airbnbs are in the Manhatten neighbourhood group, are either private rooms or entire home/aprt, and have a lower price and minimum nights.
